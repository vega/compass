...
define(function () {
    ...
    /**
     * Add a method to require to get callbacks if there are loader resource still
     * being loaded. If so, then hold off calling "withResources" callbacks.
     *
     * @param {Boolean} isReady: pass true if all resource have been loaded.
     */
     ...
     * loader resource. Useful when there are implicit dependencies.
