...
var importedEncodingTransitions = {
  ADD_X: { name: 'ADD_X', cost: 3.92 },
  ADD_Y: { name: 'ADD_Y', cost: 3.92 },
  ADD_COLOR: { name: 'ADD_COLOR', cost: 3.86 },
  ADD_SHAPE: { name: 'ADD_SHAPE', cost: 3.9 },
  ADD_SIZE: { name: 'ADD_SIZE', cost: 3.88 },
  ADD_X_COUNT: { name: 'ADD_X_COUNT', cost: 3.91 },
  ADD_Y_COUNT: { name: 'ADD_Y_COUNT', cost: 3.91 },
  ADD_COLOR_COUNT: { name: 'ADD_COLOR_COUNT', cost: 3.85 },
  ADD_SHAPE_COUNT: { name: 'ADD_SHAPE_COUNT', cost: 3.89 },
  ADD_SIZE_COUNT: { name: 'ADD_SIZE_COUNT', cost: 3.87 },
  REMOVE_X_COUNT: { name: 'REMOVE_X_COUNT', cost: 3.83 },
  REMOVE_Y_COUNT: { name: 'REMOVE_Y_COUNT', cost: 3.83 },
  REMOVE_COLOR_COUNT: { name: 'REMOVE_COLOR_COUNT', cost: 3.81 },
  REMOVE_SHAPE_COUNT: { name: 'REMOVE_SHAPE_COUNT', cost: 3.77 },
  REMOVE_SIZE_COUNT: { name: 'REMOVE_SIZE_COUNT', cost: 3.79 },
  REMOVE_X: { name: 'REMOVE_X', cost: 3.84 },
  REMOVE_Y: { name: 'REMOVE_Y', cost: 3.84 },
  REMOVE_COLOR: { name: 'REMOVE_COLOR', cost: 3.82 },
  REMOVE_SHAPE: { name: 'REMOVE_SHAPE', cost: 3.78 },
  REMOVE_SIZE: { name: 'REMOVE_SIZE', cost: 3.8 },
  MODIFY_X: { name: 'MODIFY_X', cost: 3.78 },
  MODIFY_Y: { name: 'MODIFY_Y', cost: 3.78 },
  MODIFY_COLOR: { name: 'MODIFY_COLOR', cost: 3.95 },
  MODIFY_SHAPE: { name: 'MODIFY_SHAPE', cost: 3.78 },
  MODIFY_SIZE: { name: 'MODIFY_SIZE', cost: 3.78 },
  MODIFY_X_ADD_COUNT: { name: 'MODIFY_X_ADD_COUNT', cost: 3.77 },
  MODIFY_Y_ADD_COUNT: { name: 'MODIFY_Y_ADD_COUNT', cost: 3.77 },
  MODIFY_COLOR_ADD_COUNT: { name: 'MODIFY_COLOR_ADD_COUNT', cost: 3.94 },
  MODIFY_SHAPE_ADD_COUNT: { name: 'MODIFY_SHAPE_ADD_COUNT', cost: 3.77 },
  MODIFY_SIZE_ADD_COUNT: { name: 'MODIFY_SIZE_ADD_COUNT', cost: 3.77 },
  MODIFY_X_REMOVE_COUNT: { name: 'MODIFY_X_REMOVE_COUNT', cost: 3.76 },
  MODIFY_Y_REMOVE_COUNT: { name: 'MODIFY_Y_REMOVE_COUNT', cost: 3.76 },
  MODIFY_COLOR_REMOVE_COUNT: { name: 'MODIFY_COLOR_REMOVE_COUNT', cost: 3.93 },
  MODIFY_SHAPE_REMOVE_COUNT: { name: 'MODIFY_SHAPE_REMOVE_COUNT', cost: 3.76 },
  MODIFY_SIZE_REMOVE_COUNT: { name: 'MODIFY_SIZE_REMOVE_COUNT', cost: 3.76 },
  MOVE_X_SIZE: { name: 'MOVE_X_SIZE', cost: 3.76 },
  MOVE_X_SHAPE: { name: 'MOVE_X_SHAPE', cost: 3.76 },
  MOVE_X_COLOR: { name: 'MOVE_X_COLOR', cost: 3.76 },
  MOVE_X_Y: { name: 'MOVE_X_Y', cost: 3.76 },
  MOVE_Y_SIZE: { name: 'MOVE_Y_SIZE', cost: 3.76 },
  MOVE_Y_SHAPE: { name: 'MOVE_Y_SHAPE', cost: 3.76 },
  MOVE_Y_COLOR: { name: 'MOVE_Y_COLOR', cost: 3.76 },
  MOVE_Y_X: { name: 'MOVE_Y_X', cost: 3.76 },
  MOVE_COLOR_SIZE: { name: 'MOVE_COLOR_SIZE', cost: 3.76 },
  MOVE_COLOR_SHAPE: { name: 'MOVE_COLOR_SHAPE', cost: 3.76 },
  MOVE_COLOR_Y: { name: 'MOVE_COLOR_Y', cost: 3.76 },
  MOVE_COLOR_X: { name: 'MOVE_COLOR_X', cost: 3.76 },
  MOVE_SHAPE_SIZE: { name: 'MOVE_SHAPE_SIZE', cost: 3.76 },
  MOVE_SHAPE_COLOR: { name: 'MOVE_SHAPE_COLOR', cost: 3.76 },
  MOVE_SHAPE_Y: { name: 'MOVE_SHAPE_Y', cost: 3.76 },
  MOVE_SHAPE_X: { name: 'MOVE_SHAPE_X', cost: 3.76 },
  MOVE_SIZE_SHAPE: { name: 'MOVE_SIZE_SHAPE', cost: 3.76 },
  MOVE_SIZE_COLOR: { name: 'MOVE_SIZE_COLOR', cost: 3.76 },
  MOVE_SIZE_Y: { name: 'MOVE_SIZE_Y', cost: 3.76 },
  MOVE_SIZE_X: { name: 'MOVE_SIZE_X', cost: 3.76 },
  SWAP_X_Y: { name: 'SWAP_X_Y', cost: 3.76 } };
